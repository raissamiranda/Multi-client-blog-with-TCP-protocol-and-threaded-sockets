...
struct BlogOperation createOperation(int clientID, int operationType, int serverResponse, char topic[50], char content[2048])
{
...
// Capture the address and port from the command line and store it in a sockaddr_storage structure
